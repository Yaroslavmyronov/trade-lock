import deployedContracts from '@/shared/config/contracts/deployedContracts';
import externalContracts from '@/shared/config/contracts/externalContracts';
...
import { getParsedError } from '../web3/getParsedError';
...
export type ConfiguredChainId = (typeof dappConfig)['targetNetworks'][0]['id'];
...
export type UseWrapperReadConfig<
  TContractName extends ContractName,
...
> = {
  ...
  } & UseArgsParam<TContractName, TFunctionName> &
    Omit<
      UseReadContractParameters,
...
export type WrapperWriteContractVariables<
  TContractName extends ContractName,
  TFunctionName extends ExtractAbiFunctionNames<
    ContractAbi<TContractName>,
...
export type WrapperWriteContractOptions = MutateOptions<
  WriteContractReturnType,
  WriteContractErrorType,
  WriteVariables,
  unknown
...
export type UseWriteConfig<TContractName extends ContractName> = {
  contractName: TContractName;
  chainId?: ConfiguredChainId;
